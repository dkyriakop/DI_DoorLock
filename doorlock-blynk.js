...
//
// **************************************** //
var unlockedState = 1050;
var lockedState = 2110;

var motorPin = 14;
var buttonPin = 4
var ledPin = 17

var blynkToken = 'c9493fbdd62945b4a75f023129fa4e3a';
...
function lockDoor() {
	...
	//notify
  	blynk.notify("Hacka's Door has been unlocked!");
...
function unlockDoor() {
	...
	//notify
  	blynk.notify("Hacka's Door has been locked!"); 
